...
p(1,18:34) = p(2,1:17) - p(1,1:17);
p(end,18:34) = p(end,1:17) - p(end-1,1:17);
p(2:end-1,18:34) = p(3:end,1:17) - p(1:end-2,1:17);

p(1,35:end) = p(2,18:34) - p(1,18:34);
p(end,35:end) = p(end,18:34) - p(end-1,18:34);
p(2:end-1,35:end) = p(3:end,18:34) - p(1:end-2,18:34);
